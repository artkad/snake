...
function init() {
    ...
    window.addEventListener('keydown', handDirectionChange);
    }

    function handDirectionChange(event) {
...
function respawn() {
    ...
    var $table = document.getElementById('game-table');
    $snakeHead = $table.children[snakeCoordX].children[snakeCoordY];
    $snakeTail = $table.children[--snakeCoordX].children[snakeCoordY];
